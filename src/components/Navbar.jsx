...
// This theme is passed as a props from app component via ThemeProvider From MUI.
// styled("div") -> styles as div ele
...
// Box is like div in MUI
// styled("Box") -> styles as Box ele
const Icons = styled(Box)(({ theme }) => ({
  // smaller than (sm) approx 600px then disply set to be none else block
  display: "none",
  alignItems: "center",
  gap: "20px",
  //[ ... ]tells JavaScript to evaluate that expression and use its result as the key
  // up("sm") qual to small or above
